...
@doc raw"""
    wc_gradient_descent_quadratic_lojasiewicz_expensive(L, mu, gamma, n; solver=Clarabel.Optimizer, verbose=true)
...
details can be found in [1,2,3]. The example here relies on the `SmoothQuadraticLojasiewiczFunctionExpensive`
